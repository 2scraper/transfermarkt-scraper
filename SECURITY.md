...
**"transfermarkt-scraper security"** in the subject — otherwise it lands in a
...
- **Bypassing Transfermarkt's bot protection.** This scraper drives an
  ...
  repository.
- **The scraper stopped working.** Transfermarkt changing its markup is
